            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tech.map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 text-xs bg-gray-100 dark:bg-gray-900 rounded-full"
                  >
                    {tech}
                  </span>
                ))}
              ...
              <div className="flex items-center gap-4">
                {project.github && (
                  <a
                    ...
                    className="text-sm hover:text-gray-600 dark:hover:text-gray-300 transition-colors flex items-center gap-1"
                  >
